...
import ExtendedNavItemComponent, {
  ExtendedNavItemComponent2,
} from "./ExtendedNavItemComponent/ExtendedNavItemComponent";
...
const NavbarComponent = (props) => {
  ...
  useEffect(() => {
    ...
    $navlink.toggleClass(
      "scrolled",
      $(document).scrollTop() > $navlink.height()
    );
    $nav_link_dropper.toggleClass(
      "scrolled",
      $(document).scrollTop() > $navlink.height()
    );
    $navitem.toggleClass(
  ...
  return (
    <React.Fragment>
      <div
        className="d-flex justify-content-end ml-0 mr-0"
        style={{ height: "26px" }}
      >
        <div id="top_bar" className="header_font">
          <Link
            id="members_only_link"
            className="pulsating-circle"
            to="/MEMBERSHIP/MEMBERSONLY"
          >
        ...
        <div>
          ...
          <Navbar
            ...
            className={`
                        ...
                        ${Scrolled ? "scrolled" : ""} 
                        ${
                          !Scrolled && !(props.location.pathname === "/")
                            ? "dark_bg"
                            : ""
                        }
                        ${!isOpen ? "" : "collapsed"}
          ...
          >
            <NavbarBrand id="nav_brand" href="/" className="p-0">
              <img
                ...
                src={
                  !Scrolled && $(window).width() > 768 ? logo_white : logo_black
                }
                alt="oval"
              />
            </NavbarBrand>
            ...
            <Collapse isOpen={isOpen} navbar className="justify-content-end">
              <div
                style={{ height: $(window).width() > 768 ? "100%" : "auto" }}
              >
                <Nav className="ml-auto d-flex nav_list" navbar style={{}}>
                  <NavItem
                    className={`${
                      props.location.pathname !== "/" ? "" : "nav-link-selected"
                    } `}
                  >
                    ...
                    sub_navs={[
                      ...
                      },
                      {
                        ...
                        sub_subs: [
                          ...
                          {
                            path: "/ABOUTUS/STAFF/AMBASSADORS",
                            text: "Ambassadors",
                          },
                      ...
                      {
                        path: "/ABOUTUS/working_groups",
                        text: "working groups",
                        sub_subs: [
                          {
                            path: "/ABOUTUS/working_groups/future-mobility-club",
                            text: "Future Mobility Club",
                          },
                          {
                            path: "/ABOUTUS/working_groups/climate-finance",
                            text: "Climate Finance",
                          },
                          {
                            path: "/ABOUTUS/working_groups/energy-efficiency",
                            text: "Energy Efficiency ",
                          },
                          {
                            path: "/ABOUTUS/working_groups/hydrogen-and-energy-storage",
                            text: "Hydrogen and Energy Storage",
                          },
                          {
                            path: "/ABOUTUS/working_groups/women-in-clean-energy",
                            text: "Women in Clean Energy",
                          },
                        ],
                      },
                      {
                        path: "/ABOUTUS/programms",
                        text: "programmes",
                        sub_subs: [
                          {
                            path: "/ABOUTUS/working_groups/cebc-schools",
                            text: "CEBC Schools",
                          },
                        ],
                      },
