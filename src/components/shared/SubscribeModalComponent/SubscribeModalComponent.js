  ...
  const onSubmit = async (values, submitProps) => {
    ...
    try {
      ...
      const response = await fetch(
        `${process.env.REACT_APP_BACKEND_URL}/applicatoin-for-newsletter-subscriptions`,
        {
          method: "POST",
          headers: {
        ...
        >
          ...
          <ModalBody style={{ padding: "0px" }}>
            ...
            <Row style={{ padding: "0px 20px" }}>
              <Col
                className="subscribe_modal_left_col"
                md={4}
                      ...
                      <Form className="modal_form">
                        <Row className="formik-control">
                          ...
                          <Col
                            ...
                            style={{ padding: "0px" }}
                          >
                            <label className="formik-label" htmlFor="last_name">
                              Last Name:
                            </label>
                          </Col>
                          <Col
                        ...
                        <Row className="formik-control">
                          <Col
                            ...
                            style={{ padding: "0px" }}
                          >
                            <label className="formik-label" htmlFor="company">
                              Company:
                            </label>
                          </Col>
                          <Col
                        ...
                        <Row className="formik-control"></Row>
