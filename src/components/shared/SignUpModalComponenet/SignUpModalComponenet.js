  ...
  const onSubmit = async (values, submitProps) => {
    ...
    try {
      ...
      const response = await fetch(
        `${process.env.REACT_APP_BACKEND_URL}/applications-for-user-accounts`,
        {
          method: "POST",
          headers: {
    ...
    <>
      <div id="sign_up_modal">
        <Modal
          ...
          isOpen={IsSignUpModalShown}
          toggle={toggle}
        >
          <div style={{}}></div>
          <ModalBody style={{ padding: "0px" }}>
            <div className="modal_header">sign up for a cebc user account</div>
            <Row style={{ padding: "20px" }}>
              <Col md={4}>
                <div className="su_left_col" style={{}}>
                  ...
                  >
                    Only individuals belonging to CEBC member entities can sign
                  ...
                  >
                    For an account, fill in the form and we will contact you
                    soon.
                  </div>
                </div>
              </Col>
