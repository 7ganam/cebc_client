  ...
  return (
    <>
      <SubscribeModalComponent
        toggle={toggle_subscribe_modal}
        ModalIsOpen={SubscribeModalIsOpen}
      />
      <ContactUsModalComponent
        toggle={toggle_contact_modal}
      ...
      <div className="sticke_div">
        <div className="subcripe-sticker">
          <div
            ...
            className="sticker_body"
            onClick={toggle_subscribe_modal}
          >
