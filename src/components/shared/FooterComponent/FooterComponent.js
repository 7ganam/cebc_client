                ...
                <aside id="text-22" className="widget widget_text">
                  ...
                  <div className="textwidget">
                    <span className="footer-cebc">
                      Registered as a Not for Profit Company in Abu Dhabi Global
                      Market (ADGM), the Clean Energy Business Council is the
                      pre-eminent organization representing the private sector
                      involved in the clean energy sector across the MENA
                      region.
                    </span>
                  </div>
                  ...
                  <div className="textwidget">
                    <p>
                      ...
                      <span className="footer-contact">
                        Abu Dhabi Global Market (ADGM), Abu Dhabi, U.A.E.
                      </span>
                    </p>
                    <p>
                    ...
                    <p>
                      ...
                      <span className="footer-contact">
                        <a
                          onClick={open_contact_form}
                          href="http://www.cebcmena.com/contactus/"
                          style={{ color: " #babfc5" }}
                        >
                          You may also contact us using this form
                        </a>
                      </span>
                    </p>
                  </div>
                      ...
                      <ul id="services">
                        <li>
                          <div className="facebook">
                            <a href="#">
                              <i
                                className="fab fa-facebook  i_link"
                                aria-hidden="true"
                              ></i>
                            </a>
                          </div>
                        ...
                        <li>
                          <div className="youtube">
                            <a href="https://www.youtube.com/channel/UCqI6y1W2l5S1-nMZQk3z23w">
                              <i
                                className="fab fa-youtube i_link"
                                aria-hidden="true"
                              ></i>
                            </a>
                          </div>
                        ...
                        <li>
                          <div className="instagram">
                            <a href="https://www.instagram.com/accounts/login/?next=/cleanenergybusinesscouncil/%3Fhl%3Den ">
                              <i
                                className="fab fa-instagram i_link"
                                aria-hidden="true"
                              ></i>
                            </a>
                          </div>
