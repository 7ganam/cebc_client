...
function NewsViewPageComponent(props) {
  ...
  const fetchNews = useCallback(async () => {
    try {
      ...
      const modified_news_post = news_post.replace(
        "/uploads",
      ...
      <div id="news_box">
        {!!LoadedNews ? (
          <div>
            <div id="news_header">
              ...
              >
                {LoadedNews.thumbnail_image ? (
                  ...
                  >
                    <img
                      src={s3_map(`${LoadedNews.thumbnail_image.url}`)}
            ...
            <div id="news_header_2"></div>
            <div id="news_body">
              <div style={{}}>
                <div style={{ width: "100%", margin: "auto" }}>
                  <Editor value={LoadedNews.page} onChange={(input) => {}} />
                </div>
              </div>
            </div>
          </div>
