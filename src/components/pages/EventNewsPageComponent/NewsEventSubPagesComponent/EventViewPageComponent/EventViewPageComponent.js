...
function EventViewPageComponent(props) {
  ...
  const fetchEvent = useCallback(async () => {
    try {
      ...
      const modified_event_post = event_post.replace(
        "/uploads",
        `${process.env.REACT_APP_BACKEND_URL}/uploads`
      );
      let modified_event = {
        ...responseData[0],
        event_post: modified_event_post,
      };
            ...
            <div>
              <div id="event_header">
                ...
                >
                  {LoadedEvent.Event_thumbnail_image ? (
                    ...
                    >
                      <img
                        src={s3_map(`${LoadedEvent.Event_thumbnail_image.url}`)}
              ...
              <div id="event_header_2">
                ...
                >
                  ...
                  <span>
                    {moment(LoadedEvent.Event_date).format("DD-MMMM-YYYY")}
                  </span>
                </div>
              </div>
              <div id="event_body">
                {LoadedEvent.Event_gallery &&
            ...
            {LoadedEvent.downloads.length > 0 && (
              <>
                <div className="downloads_header ">
                  <span className="downloads_header_inner">Downloads</span>
                </div>
