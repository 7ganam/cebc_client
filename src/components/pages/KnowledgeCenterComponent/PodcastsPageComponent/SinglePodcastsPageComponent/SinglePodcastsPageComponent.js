...
function SinglePodcastsPageComponent(props) {
  ...
  const the_podcast = props.podcasts.filter(
    (podcast) => podcast.slug == podcast_slug
  )[0]; //leave this as two ==
    ...
    return (
      <>
        ...
        <Container>
          <Row>
            <div
              style={{ height: "100vh", margin: "auto", marginTop: "200px" }}
            >
        ...
        {!!the_podcast && (
          ...
          >
            {!!the_podcast && the_podcast.soundcloud_embed_string && (
              <div
                className="sound_cloud_plugin"
                dangerouslySetInnerHTML={{
                  __html: the_podcast.soundcloud_embed_string,
                }}
              />
            )}
              ...
              {!!the_podcast && !!the_podcast.google_podcasts_link && (
                <a href={the_podcast.google_podcasts_link}>
                  ...
                  >
                    ...
                    <div className="pod_card_text">google podcasts</div>
                  </div>
                </a>
              )}
                ...
                <a href={the_podcast.apple_podcasts_link}>
                  <div className="pod_button" style={{}}>
                    <img
                      ...
                      style={{ height: "50px", width: "auto", margin: "10px" }}
                    />
                    <div className="pod_card_text">apple podcasts</div>
                  </div>
                </a>
              )}
            </div>
