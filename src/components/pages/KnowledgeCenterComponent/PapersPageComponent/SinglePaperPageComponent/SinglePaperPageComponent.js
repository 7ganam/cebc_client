            ...
            <Col className="p-0" md={4} style={{ background: "" }}>
              {!!props.papers.length > 0 && (
                <div className="paper_image_box">
                  <img
                    src={`${the_paper.image && the_paper.image.url}`}
                  ...
                  <div>
                    <div id="paper_header">
                      ...
                      <div class="open_paper_button">
                        <a
                          target="_blank"
                          href={the_paper.file && the_paper.file.url}
                        >
                    ...
                    <div id="paper_header_2"></div>
                    <div id="paper_body">
                      <div style={{}}>
                        <div style={{ width: "100%", margin: "auto" }}>
                          <Editor
                            value={the_paper.description}
                            onChange={(input) => {}}
                          />
                        </div>
                      </div>
