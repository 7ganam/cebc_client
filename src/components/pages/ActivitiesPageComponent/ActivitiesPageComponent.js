...
const activiites = [
  {
    image:
      "https://cebc3.s3.eu-central-1.amazonaws.com/Policy_Working_Group_Photo_6_a2b1fc7c60.jpg",
    title: "EVENTS",
  ...
  {
    image:
      "https://cebc3.s3.eu-central-1.amazonaws.com/podcasting_pic_e077e0a2ce.jpg",
    title: "PODCAST",
        ...
        <Row className=" justify-content-center">
          <Col>
            <div
              class="page_header"
              style={{
                backgroundImage: `url("https://cebc3.s3.eu-central-1.amazonaws.com/1_2e02b2841f.jpg")`,
              }}
            >
      ...
      <Container>
        <Row className="title_row">
          <div className="section_header section_header_side">
            <span className="section_header_inner">Our Activities :</span>
            <div className="section_header_under"></div>
          </div>
        </Row>

        <div className="activities_div">{render_activities(activiites)}</div>
      </Container>
    </div>
  );
}
