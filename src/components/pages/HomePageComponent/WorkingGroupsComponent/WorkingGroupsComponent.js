        ...
        <Col className="working_group_col" xs="12" md="7" lg="4" style={{}}>
          <Link className="" to={`/ABOUTUS/working_groups/${group.slug}`}>
            <div className="working_group_col_div">
              <WorkingGroupCardComponent
                image={group.Thumb_nail_image}
                title={group.Name}
              />
            </div>
          </Link>
        ...
        <Row className=" justify-content-center">
          <Col>
            <div class="sub_page_header" style={{ marginTop: "50px" }}>
              {props.type === "programm" ? (
                <span class="sub_page_header_inner">programmes</span>
              ) : (
                <span class="sub_page_header_inner">Working groups</span>
              )}
        ...
        <Row className=" justify-content-center">
          <Link to="/MEMBERSHIP/JOIN" style={{ textDecoration: "none" }}>
            <div className="end_div">
              <h4 className="end_text">BECOME A MEMBER</h4>
            </div>
          </Link>
        </Row>
      </Container>
