  ...
  return (
    <div>
        ...
        <Row className=" justify-content-center">
          <Col>
            <div
              ...
              style={{
                backgroundImage: `url("https://cebc3.s3.eu-central-1.amazonaws.com/sheikh_zayed_road_4k_1547938105_c01a610c75.jpg")`,
              }}
            >
              <div className="page_header_inner">
                <div className="page_header_inner_text"> About the CEBC</div>
                <div className="page_header_inner_dot"></div>
              </div>
        ...
        <Container>
          <Row className="title_row">
            <div className="section_header section_header_side">
              <span className="section_header_inner">What We Do</span>
          ...
          <Row>
            ...
            >
              ...
              <div className="mt-3">
                ...
                network with high-level industry players. CEBC is an accredited
                observer at the Green Climate Fund and partner of the UNDP,
                IRENA Coalition for Action and the Research Council of Oman and
                Masdar.
              </div>
      ...
      <Container>
        <Row className="title_row">
          <div className="section_header section_header_side">
            <span className="section_header_inner">VISION AND MISSION</span>
            <div className="section_header_under"></div>
          </div>
        </Row>
