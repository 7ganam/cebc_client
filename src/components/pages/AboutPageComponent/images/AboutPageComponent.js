    ...
    <div>
      ...
      <div style={{ overflow: "hidden" }}>
        ...
        <Container style={{ marginTop: "150px", marginBottom: "150px" }}>
          <Col sm="12">
            <div className="section_head_title">
              <div className="panel__title">vision and mission</div>
            </div>
          </Col>
            ...
            <Col md={{ size: 6 }}>
              <div className="media">
                ...
                <div className="media-body align-content-start text-left">
                  ...
                  Establish a leading forum for companies and government
                  entities focused on the development and deployment of clean
            ...
            <Col md={{ size: 6 }}>
              <div className="media">
                ...
                <div className="media-body align-content-start text-left">
                  ...
                  policy development and regulation of this rapidly developing
                  and exciting sector;
                </div>
              </div>
            </Col>
            ...
            <Col md={{ size: 6 }}>
              <div className="media">
                ...
                <div className="media-body align-content-start text-left">
                  ...
                  to ensure relevant benchmarking and transparency in the
                  sectors development;
                </div>
              </div>
            </Col>
            <Col md={{ size: 6, order: 2, offset: 6 }}>
              <div className="media">
                ...
                <div className="media-body align-content-start text-left">
                  ...
                  the region to meet low carbon targets and sustainability
                  goals.
                </div>
              </div>
            </Col>
              ...
              <Col sm="12">
                <div className="section_head_title">
                  <div className="panel__title">
                    We work with an aim to achieve thee Sustainable Development
                    Goals (SDddGs)
                  </div>
                </div>
              </Col>
              <Col
                className="SDGs_col justify-content-center align-items-center d-flex flex-column mb-5"
                md="2"
              >
          ...
          <Row id="working_area_row" className="justify-content-center">
            <Col sm="12">
              <div className="section_head_title">
                <div className="panel__title">OUR WORKING AREA</div>
              </div>
            </Col>

            <Col
              id="working_area_col_1"
              className=" justify-content-center align-items-center d-flex flex-column"
              md="4"
            >
              <div
                className="vision_mission_col justify-content-center align-items-center d-flex flex-column my-4"
                md="12"
              >
            ...
            <Col
              id="working_area_col_2"
              className=" justify-content-center align-items-center d-flex flex-column "
              md="8"
            >
              <div
                className="working_area_div_2 mb-2 d-flex flex-column"
        ...
        <Container className="partition_separator board_separator" fluid>
          <div>
            <div className="panel__title">THE CEBC BOARD</div>
          </div>
        </Container>
        ...
        <Container id="board_content">
          <Row className=" justify-content-center align-items-center">
            <Col
              className="board_col justify-content-center align-items-center d-flex flex-column my-2"
              md="4"
              lg="3"
            >
              <div className="board_div mb-2">
                <Card>
                  ...
                  <CardBody>
                    <CardText>
                      Partner, Dentons Dubai and Vice-Chair of the Clean Energy
                      Business Council.
                    </CardText>
        ...
        <Container className="partition_separator board_separator" fluid>
          <div className="panel__title">CEBC TEAM</div>
        </Container>
