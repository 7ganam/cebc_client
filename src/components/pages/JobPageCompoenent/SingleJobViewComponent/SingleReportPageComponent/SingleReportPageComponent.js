...
function SingleReportPageComponent(props) {
  ...
  const the_report = props.reports.filter(
                ...
                <div className="report_image_box">
                  {!!the_report && the_report.image ? (
                    <img
                      ...
                      src={`${the_report.image && the_report.image.url}`}
                  ...
                  {!!the_report && !!props.reports.length > 0 && (
                    <div className="open_report_button">
                      <a
                        target="_blank"
                        href={the_report.file && the_report.file.url}
              ...
              <div className="report_box">
                {!!the_report && !!props.reports.length > 0 ? (
                  <div>
                    ...
                    <div id="report_header_2"></div>
                    <div id="report_body">
                      <div style={{}}>
                        <div style={{ width: "100%", margin: "auto" }}>
                          <Editor
                            value={the_report.description}
                            onChange={(input) => {}}
                          />
                        </div>
                      </div>
                  ...
                  <Row className=" justify-content-center">
                    <Col style={{ paddingTop: "0px" }}>
                      <div class="section_header">
                        <span class="section_header_inner">REPORT DETAILS</span>
