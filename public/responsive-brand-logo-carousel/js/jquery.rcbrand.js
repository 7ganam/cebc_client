  ...
  $.fn.rcbrand = function (options) {
    ...
    var methods = {
      ...
      appendHTML: function () {
        ...
        object.wrap(
          "<div class='rc-rcbrand-container'><div class='rc-rcbrand-inner'></div></div>"
        );
        object.find("li").addClass("rc-rcbrand-item");

        if (
          settings.navigationTargetSelector &&
          $(settings.navigationTargetSelector).length > 0
        ) {
          $(
            "<div class='rc-rcbrand-nav-left'></div><div class='rc-rcbrand-nav-right'></div>"
      ...
      calculateNonInfiniteRightScroll: function (toScroll) {
        methods.clearDisabled();
        var negativeOffsetLimit =
          itemCount * itemsWidth - itemsVisible * itemsWidth;
